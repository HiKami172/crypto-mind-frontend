...
import { TreeItem2Provider, TreeItem2ProviderProps } from '@mui/x-tree-view/TreeItem2Provider';
...
const CustomTreeItem = React.forwardRef(function CustomTreeItem(
  ...
  const TreeItem2ProviderWrapper = TreeItem2Provider as React.ComponentType<TreeItem2ProviderProps>;

  return (
      <TreeItem2ProviderWrapper itemId={itemId}>
